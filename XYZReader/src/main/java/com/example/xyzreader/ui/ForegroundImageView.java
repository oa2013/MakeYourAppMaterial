...
/**
 * Source: https://github.com/udacity/ud862-samples/blob/master/Unsplash/app/src/main/java/com/example/android/unsplash/ui/ForegroundImageView.java
 */
public class ForegroundImageView extends ImageView {
    ...
    public ForegroundImageView(Context context, AttributeSet attrs) {
        ...
        final Drawable d = a.getDrawable(R.styleable.ForegroundView_foregroundGravity);
        if (d != null) {
            setForeground(d);
        }
        a.recycle();
